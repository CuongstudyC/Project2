...
class VNPay
{
     ...
     *
     */
    static $vnp_TmnCode = "GAEDBE4P"; //Mã website tại VNPAY
    static $vnp_HashSecret = "IIEQIYAPMYCGPJSVXZZNDIZMZOHQAJKQ"; //Chuỗi bí mật
    static $vnp_Url = "http://sandbox.vnpayment.vn/paymentv2/vpcpay.html";
    static $vnp_Returnurl = "/users/vnPayCheck"; //Chú ý cấu hình env('APP_URL') khi sử dụng biến này.
