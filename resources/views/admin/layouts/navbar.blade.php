...
<nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right custom-chat">
                {{-- tí viết tiếp ở đây --}}
        ...
        <li class="nav-item">
            <span class="nav-link" data-widget="control-sidebar" data-controlsidebar-slide="true" href="#"
                role="button">
        ...
        <li class="nav-item dropdown">
            <span class="dropdown-item " href="{{ route('logout_admin') }}" style="margin-top:4%;"
